...
- Keep the MVP mock/local except the approved PocketBase auth and item persistence integration: no additional backend calls, databases, sync, or real Gemini integration unless a later spec explicitly adds them.
